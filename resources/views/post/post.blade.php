            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Post table</h6>
                        <a class="badge badge-sm bg-gradient-success" href="{{route('post.create')}}">Create post</a>
                    </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <h4 class="mb-0 text-sm">{{$post->id}}</h4>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="align-middle text-center">
                                            <p class="text-xs font-weight-bold mb-0">{{$post->updated_at}}</p>
                                        </td>
                                        <td class="align-middle">
                                            <a href="{{route('post.show', $post->id)}}" class="badge badge-sm bg-gradient-success text-xs" data-toggle="tooltip" data-original-title="Show post">
                                                Show
                                            </a>
                                        </td>
                                        <td class="align-middle">
                                            <a href="{{route('post.edit', $post->id)}}" class="badge badge-sm bg-gradient-success text-xs" data-toggle="tooltip" data-original-title="Edit post">
                                                Edit
                                            </a>
                                        </td>
                                        <td class="align-middle">
